...
case $key in
    ...
    restart_frontend)
     ...
     ;;
    restart)
       CMD="restart nrp && restart nrp2 && restart nrp3 && restart nrp4 && restart nrp5 && restart frontend"
       shift
     ;;
    start)
       CMD="restart nrp && restart nrp2 && restart nrp3 && restart nrp4 && restart nrp5 && restart frontend"
    ...
    ;;
    stop)
      CMD="stop nrp && stop nrp2 && stop nrp3 && stop nrp4 && stop nrp5 && stop frontend"
      shift
    ;;
    reset_backend)
      CMD="restore nrp2"
